...
import com.kyriakosalexandrou.bluetoothtoolkit.ui.graphs.HtmGraph;
...
public class HtmDeviceActivity extends BleBaseSingleDeviceActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState, R.layout.activity_ble_htm, new HtmDeviceManager(this, this));
